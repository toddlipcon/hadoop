...
class Iface:
  ...
  def read(self, size, offset, handle):
    """
    Parameters:
     - size
     - offset
...
class Client(Iface):
  ...
  def send_write(self, data, handle):
  ...
  def send_read(self, size, offset, handle):
...
class Processor(Iface, TProcessor):
  ...
  def process_write(self, seqid, iprot, oprot):
    ...
    result = write_result()
    try:
      result.success = self._handler.write(args.data, args.handle)
    except ThriftIOException, ouch:
      result.ouch = ouch
  ...
  def process_read(self, seqid, iprot, oprot):
    ...
    result = read_result()
    try:
      result.success = self._handler.read(args.size, args.offset, args.handle)
    except ThriftIOException, ouch:
      result.ouch = ouch
...
class write_args:
  ...
  thrift_spec = None
  def __init__(self, data=None, handle=None,):
    self.data = data
    self.handle = handle
...
class read_args:
  ...
  thrift_spec = None
  def __init__(self, size=None, offset=None, handle=None,):
    self.size = size
    self.offset = offset
    self.handle = handle
