          ...
          module API
            module Datanode
              class Client
                ...
                def readBlock(ctx, block, offset, length)
                  send_readBlock(ctx, block, offset, length)
                  return recv_readBlock()
                end

                def send_readBlock(ctx, block, offset, length)
                  send_message('readBlock', ReadBlock_args, :ctx => ctx, :block => block, :offset => offset, :length => length)
                end
              ...
              class Processor
                ...
                def process_readBlock(seqid, iprot, oprot)
                  ...
                  begin
                    result.success = @handler.readBlock(args.ctx, args.block, args.offset, args.length)
              ...
              class ReadBlock_args
                ...
                ::Thrift::Struct.field_accessor self, :ctx, :block, :offset, :length
                FIELDS = {
